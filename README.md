...
![Blender](https://img.shields.io/badge/Blender-3.0%2B-orange?style=for-the-badge&logo=blender&logoColor=white)
...
> ⚠️ **Blender 4.0+ users:** The Collada (`.dae`) importer was removed. Install an older Blender (3.x) **alongside** your current version just for importing — your main version still works fine for everything else.
...
- Blender 4.x compatibility improvements
